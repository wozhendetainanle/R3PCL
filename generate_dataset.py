...
from data_generation.generalization_tasks import TASKS
...
def generate_dataset(task_name, task_fn_gen, data_path='', image_size=128, seed=0, train_size=10000, val_size=500,  test_size=1000):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='../mcr/', help='directory to output dataset')
    parser.add_argument('--task_idx', default='38', help='index of the dataset')
    ...
    if task_idx == 'a':
        for i in range(0, 103):
            tn, tfn_g, _ = TASKS[i]
            generate_dataset(tn, tfn_g, args.data_dir, args.image_size, args.seed, args.train_size, args.val_size, args.test_size)

    else:
        task_idx = int(task_idx)
        tn, tfn_g, _ = TASKS[task_idx]
        generate_dataset(tn, tfn_g, args.data_dir, args.image_size, args.seed, args.train_size, args.val_size, args.test_size)
